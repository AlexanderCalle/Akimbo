...
import DDDMood from '../assets/DDDMood.png';
  ...
  return (
    <MainLayout>
        <div className='flex md:flex-col lg:flex-row w-full h-[500px]'>
            ...
            <img className='w-full lg:w-5/6 ml-auto object-cover object-center mr-0 justify-self-end' src={DDDMood} alt="Dairy mood board" />
        </div>
